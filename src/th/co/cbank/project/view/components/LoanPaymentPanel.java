...
public class LoanPaymentPanel extends javax.swing.JPanel {
    ...
    private void initLoad() {
        ...
        if (loanConfigBean.getIntFixed().equals("E")) {
            ...
            int diffDay = th.co.cbank.util.DateUtil.diff(loanAccountBean.getPay_date(), new Date());
    ...
    private void loadPaymentHistory() {
        List<CbTransactionLoanBean> listLoan = cbTransactionLoanControl.listCbTransactionLoanPayment(loanAccountBean.getLoan_docno());
