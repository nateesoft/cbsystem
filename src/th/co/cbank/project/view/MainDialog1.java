...
public class MainDialog1 extends BaseSwing {

    private final Logger logger = Logger.getLogger(MainDialog1.class);
    private final LoginDialog login;
    private boolean profileIsActive = false;
    private boolean isEffitiveRate = false;

    public MainDialog1(java.awt.Frame parent, boolean modal) {
        initComponents();
    ...
    private void initComponents() {
        ...
        initMainPanel = new javax.swing.JPanel();
        ...
        hoonPanel = new javax.swing.JPanel();
        ...
        loanPaymentPanel = new javax.swing.JPanel();
        ...
        setTitle("ระบบบริหารธนาคารชุมชน V 1.1-2023.01.30");
        ...
        initMainPanel.setBackground(new java.awt.Color(255, 255, 255));
        initMainPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true));
        initMainPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        initMainPanel.add(lbWarning1, new org.netbeans.lib.awtextra.AbsoluteConstraints(169, 164, 748, 109));
        ...
        initMainPanel.add(lbWarning2, new org.netbeans.lib.awtextra.AbsoluteConstraints(169, 279, -1, -1));

        lbMainWarning.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/p1-(5).jpg"))); // NOI18N
        initMainPanel.add(lbMainWarning, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1070, 550));

        mainTabbedPane.addTab("", initMainPanel);

        newDepositPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        mainTabbedPane.addTab("<html><font color=white bgcolor=green>เปิดบัญชีเงินฝาก</font></html>", newDepositPanel);
        ...
        mainTabbedPane.addTab("<html><font color=white bgcolor=green>ฝาก/ถอน</font></html>", depositPanel);
        ...
        javax.swing.GroupLayout hoonPanelLayout = new javax.swing.GroupLayout(hoonPanel);
        hoonPanel.setLayout(hoonPanelLayout);
        hoonPanelLayout.setHorizontalGroup(
            hoonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(hoonPanelLayout.createSequentialGroup()
                .addComponent(jTabbedPane5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        hoonPanelLayout.setVerticalGroup(
            hoonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane5)
            .addGroup(hoonPanelLayout.createSequentialGroup()
                .addComponent(jPanel59, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        mainTabbedPane.addTab("<html><font bgcolor=yellow>ซื้อขายหุ้น</font></html>", hoonPanel);

        newLoanPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        javax.swing.GroupLayout newLoanPanelLayout = new javax.swing.GroupLayout(newLoanPanel);
        newLoanPanel.setLayout(newLoanPanelLayout);
        newLoanPanelLayout.setHorizontalGroup(
            newLoanPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(newLoanPanelLayout.createSequentialGroup()
        ...
        newLoanPanelLayout.setVerticalGroup(
            newLoanPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(newLoanPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(newLoanPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        mainTabbedPane.addTab("<html><font bgcolor=red color=white>เปิดบัญชีเงินกู้</font></html>", newLoanPanel);
        ...
        jLabel70.setText("เงินต้นคงเหลือ");
        ...
        txtLoanBalance.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        txtLoanBalance.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtLoanBalanceFocusGained(evt);
            }
        });
        ...
        jPanel34Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel34Layout.createSequentialGroup()
                ...
                .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtLoanBalance, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        jPanel34Layout.setVerticalGroup(
            ...
            .addGroup(jPanel34Layout.createSequentialGroup()
                ...
                .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtLoanBalance, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel45Layout.setVerticalGroup(
            ...
            .addGroup(jPanel45Layout.createSequentialGroup()
                ...
                .addGroup(jPanel45Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel34, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE)
                    .addGroup(jPanel45Layout.createSequentialGroup()
                        .addComponent(jLabel42)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        javax.swing.GroupLayout loanPaymentPanelLayout = new javax.swing.GroupLayout(loanPaymentPanel);
        loanPaymentPanel.setLayout(loanPaymentPanelLayout);
        loanPaymentPanelLayout.setHorizontalGroup(
            loanPaymentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane7)
            .addComponent(jPanel54, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        loanPaymentPanelLayout.setVerticalGroup(
            loanPaymentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, loanPaymentPanelLayout.createSequentialGroup()
        ...
        mainTabbedPane.addTab("<html><font bgcolor=red color=white>กู้เงิน/รับชำระ</font></html>", loanPaymentPanel);
        ...
        lbAccountType.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbAccountType.setText("ประเภทบัญชี");
        ...
        lbCountAccount.setText("จำนวนบัญชี");
        ...
        leftProfilePanelLayout.setHorizontalGroup(
            ...
            .addGroup(leftProfilePanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(leftProfilePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(leftProfilePanelLayout.createSequentialGroup()
                        .addGap(7, 7, 7)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(leftProfilePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(topMenuAction, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(mainTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 593, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void mainTabbedPaneMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mainTabbedPaneMouseClicked
        int rowSelected = mainTabbedPane.getSelectedIndex();
        if (rowSelected != -1) {
            switch (rowSelected) {
                case 0:
    ...
    private void btnApproveMoreMoneyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveMoreMoneyActionPerformed
        AddCreditLoanDialog addDialog = new AddCreditLoanDialog(this, true, txtProfileCode.getText(), txtShowEmpCode.getText());
    ...
    private void txtLoanBalanceFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtLoanBalanceFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_txtLoanBalanceFocusGained
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainDialog1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                MainDialog1 dialog = new MainDialog1(new javax.swing.JFrame(), true);
                dialog.setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel hoonPanel;
    private javax.swing.JPanel initMainPanel;
    ...
    private javax.swing.JPanel loanPaymentPanel;
    ...
    private void findCustomer() {
        ...
        if (profile != null) {
            ...
            enablePanelTrue();
            enableComponents(newDepositPanel, true);
    ...
    private void enablePanelTrue() {
        enableComponents(mainTabbedPane, true);
    }
    ...
    private void saveLoanForm() {
        ...
        if (getLoanAccountControl().createNewLoan(bean)) {
            try {
                //update running
    ...
    private void depositMoney() throws Exception {
        ...
        saveAccountControl.updateSummaryBalanceFromTransaction(txtProfileCode.getText(), txtAccCode.getText());
    ...
    private void printTransactionLoanBook(String accountCode) {
        ...
        String where = " and t_acccode='" + accountCode + "' "
                ...
                + "order by t_index ";
        List<CbTransactionLoanBean> listLoan = getCbTransactionLoanControl().listTransactionLoan(where);
    ...
    private void init1() {
        ...
        List<CbHoonConfigBean> listHoon = getHoonConfigControl().listCbHoonConfig();
        ...
        List<CbLoanConfigBean> listLoanBean = getLoanConfigControl().listLoanConfig();
    ...
    private void loadLoanDetail() {
        ...
        List<CbLoanTablePaymentBean> listTable = getCbLoanTablePaymentControl().listCbLoanTablePayment(tDocNo);
    ...
    private void loadLoanDetailPayment() {
        ...
        DefaultTableModel mdTbArGroup2 = (DefaultTableModel) tbArGroup2.getModel();
        ...
        if (bean != null) {
            ...
            txtLoanBalance.setText(NumberFormat.showDouble2(bean.getBalance_amount()));
            ...
            if (AppConstants.INT_EFFITIVE_RATE.equals(configBean.getIntFixed())) {
                ...
                computeEffectiveRate(configBean.getLoanINT(), dayCheckINT);
            }
        }
    }
    ...
    private void loadBonsman(String loan_docno) {
        List<CbBondsmanBean> listBond = getCbBondsmanControl().listCbBondsman(loan_docno);
    ...
    private boolean checkAllowWithdraw() {
        ...
        if ("2".equals(profileBean.getP_member_type())) {//ประเภทกลุ่ม
            ...
            List<CbWithdrawAllowBean> listBean = getCbWithdrawAllowControl().listCbWithdrawAllow(accCodeCheck);
    ...
    private void printFrontBook() {
        ...
        view.printFrontBook(accCode, accName, bookNo, accType);
    }
    ...
    public void loadTransactionPerson(String accoutCode) {
        ...
        List<CbTransactionSaveBean> listSave = getCbTransactionSaveControl().listTransactionSave(where);
    ...
    private void loadLoanAccount() {
        ...
        //load table
        List<CbLoanTablePaymentBean> listPayment = getCbLoanTablePaymentControl().listCbLoanTablePayment(txtAccCode.getText());
        DefaultTableModel model = (DefaultTableModel) tbArGroup1.getModel();
    ...
    private void confirmPayment2() {
        ...
        List<CbLoanTablePaymentBean> listTable = getCbLoanTablePaymentControl().listCbLoanTablePayment(txtAccCode.getText());
        boolean isNext = true;
        for (int i = 0; i < listTable.size(); i++) {
    ...
    private void loadPaymentHistory() {
        List<CbTransactionLoanBean> listLoan = getCbTransactionLoanControl().listCbTransactionLoanPayment(txtAccCode.getText());
    ...
    private void showListSelect(String accCode, String accType) {
        ...
        ListMenuDialog list = new ListMenuDialog(this, true, null, null, null, null, null);
//        ListMenuDialog list = new ListMenuDialog(this, true, accCode, accType);
    ...
    private void computeEffectiveRate(double intPerYear, int dayPeriod) {
        double principle = NumberUtil.toDouble(txtLoanBalance.getText());//เงินต้นคงเหลือ
        double intPerDay = principle * (intPerYear / 100) * dayPeriod / 365;
        txtArLoanInt.setText(NumberFormat.showDouble2("" + intPerDay));
        txtPaymentPerMonth.setText(NumberFormat.showDouble2(principle + intPerDay));
    }
    ...
    private void computeLoanInterest() {
        ...
        if (loanConfigBean.getIntFixed().equals("E")) {
            ...
            // add more int balance before
            BigDecimal intBalanceAmount = new BigDecimal(loanAccBean.getIntBalance());

            BigDecimal totalInt = balanceAmount.multiply(intPerYear).multiply(diffDayFrom);
            BigDecimal intNetTotal = totalInt.divide(yearFixDay, 0, BigDecimal.ROUND_UP).add(intBalanceAmount);
...
//            txtArLoanInt.setText(dec.format(intNetTotal.doubleValue()));
    ...
    private void confirmPaymentEff() throws Exception {
        ...
        double interestToday = getComputeTodayInt(loanAccBean);//ดอกเบี้ยที่คำนวณได้ของวันนี้
        double intBalanceBeforeAmt = loanAccBean.getIntBalance();//ดอกเบี้ยค้างชำระจากงวดที่แล้ว
        double totalIntAmt = interestToday + intBalanceBeforeAmt;//รวมดอกเบี้ยที่ต้องชำระทั้งหมด

        double arPaymentFee = NumberUtil.toDouble(txtPaymentFee.getText());//ค่าปรับชำระเกินจำนวน
        double loanAmount = loanAccBean.getLoan_amount();//เงินต้นคงเหลือ

        if (paymentAmountCash <= 0) {
            JOptionPane.showMessageDialog(this, "กรุณาระบุยอดรับชำระที่มากกว่า 0");
            return;
        }
        if (paymentAmountCash < arPaymentFee) {
        ...
        paymentAmountCash = paymentAmountCash - arPaymentFee;// ลบค่าธรรมเนียม ต้องชำระเต็มจำนวนเท่านั้น
        // step1
        ...
        // step2
        if (paymentAmountCash >= loanAmount) {
            minusBalanceAmt = loanAmount;// เท่ากับว่าลบเงินต้นออก
            paymentAmountCash = paymentAmountCash - loanAmount; // อาจมีเงินทอน
        } else {
        ...
        loanBean.setT_custcode(txtProfileCode.getText());
        loanBean.setT_description(ThaiUtil.Unicode2ASCII("รับชำระเงินกู้"));
        loanBean.setT_amount(minusBalanceAmt);
        loanBean.setT_interest(minusInterestAmt);
        loanBean.setT_loan_int_ar_int(totalIntAmt - minusInterestAmt);
        loanBean.setT_empcode(Value.USER_CODE);
        loanBean.setT_docno(txtAccCode.getText());
        loanBean.setT_booktype(AppConstants.BOOKTYPE_PAYMENT);
        loanBean.setBranch_code(Value.BRANCH_CODE);
        ...
        loanBean.setT_balance(loanAmount - minusBalanceAmt);
    ...
    private void btnRegisterActionPerformed() {
        ...
        if (btnRegister.getText().equals("เริ่มใหม่")) {
            ...
            initMainPanel.setEnabled(true);
        } else {
            SavingDialog reg = new SavingDialog(this, true, true, txtProfileCode.getText());
            reg.setVisible(true);
    ...
    private void btnEditActionPerformed() {
        ...
        if (profileIsActive) {
            SavingDialog reg = new SavingDialog(this, true, false, txtProfileCode.getText());
            reg.setVisible(true);
    ...
    private void showAccountQty() {
        List<CbSaveAccountBean> listSc = getSaveAccountControl().listCbSaveAccount(txtProfileCode.getText());
    ...
    private void txtProfileCodeKeyReleasedAction(KeyEvent evt) {
        switch (evt.getKeyCode()) {
            case KeyEvent.VK_F1:
                SavingDialog reg = new SavingDialog(null, true, true, txtProfileCode.getText());
                reg.setVisible(true);
                break;
            case KeyEvent.VK_F2:
                btnFindActionPerformed();
    ...
    private double getComputeTodayInt(CbLoanAccountBean loanBean) {
        CbLoanConfigBean configBean = getLoanConfigControl().listLoanConfig(loanBean.getLoan_type());
        String sql = "select max(t_date) t_date "
                + "from cb_transaction_loan "
                + "where t_booktype='PM' "
                + "and t_acccode='" + loanBean.getLoan_docno() + "'";
        Date lastPaymentDate = loanBean.getLoan_docdate();
        try {
            ResultSet rs = MySQLConnect.getResultSet(sql);
            if (rs.next()) {
                lastPaymentDate = rs.getDate("t_date");
            }
            rs.close();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        ...
        int dayPeriod = DateUtil.getDayDiff(lastPaymentDate, new Date());
        return (loanBean.getLoan_amount() * (configBean.getLoanINT() / 12 / 30) * dayPeriod) / 365;
    }
